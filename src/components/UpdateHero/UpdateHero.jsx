...
import { FileInput, FileLabel } from "../AddHero/AddHero.styled";
import Loader from "../Loader/Loader";
import { toast } from 'react-toastify';
import { useUpdateSuperheroMutation } from "../../redux/superheroApiSlice";
import { useNavigate, useLocation, useParams } from "react-router-dom";
import { ButtonBack } from "../HeroDetails/HeroDetails.styled";

export default function UpdateHero() {

  const [updateHero, { isLoading }] = useUpdateSuperheroMutation();
  const { id } = useParams();
...
Earth as an infant by his scientist father Jor-El, moments before Krypton's destruction…"
          ...
          >
            ...
            <ButtonBack type='button' onClick={onClickBack}>Back to hero</ButtonBack>
        </Box>
        </Box>
      </Container>
      </>
